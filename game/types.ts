...
export type GameState = {
  ...
  owned: Record<string, number>; incomeStreams: Record<string, number>; businesses: BusinessPortfolio; cityEconomy: CityEconomyState; time: TimeSimulationState; life: LifeRpgState; career?: CareerState; rules: GameRules; debt?: DebtState;
