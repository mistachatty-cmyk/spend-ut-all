...
export type ItemCategory =
  ...
  | "business"
  | "infrastructure";
export type CitySpecializationId =
  | "finance"
  | "technology"
  | "industrial"
  | "tourism";
...
export type AchievementConditionId =
  | "nothing-millionaire"
  | "nothing-billionaire"
  | "nothing-trillionaire"
  | "nothing-first-business"
  | "nothing-first-home"
  | "nothing-town"
  | "nothing-metropolis"
  | "nothing-planetary"
  ...
  | "hundred-x-win"
  | "thousand-x-win"
  | "no-sales-millionaire"
  | "debt-comeback"
  | "deep-debt-comeback"
  | "diversified"
  | "all-businesses"
  | "positive-million-income"
  | "exact-zero"
  | "moon-and-metropolis"
  | "collector-cashflow"
  | "risk-millionaire"
  | "nothing-million-speed-2m"
  | "nothing-million-speed-5m"
  | "nothing-million-speed-10m"
  | "billion-speed-30m"
  | "town-speed-15m"
  | "metropolis-speed-60m"
  | "wolf-first-billion"
  | "wolf-three-businesses"
  | "wolf-million-income"
  | "wolf-market-master"
  | "wolf-risk-billionaire"
  | "debt-10k-comeback"
  | "debt-1m-comeback"
  | "debt-100m-comeback"
  | "debt-billion-comeback"
  | "near-bankruptcy-comeback"
  | "nothing-no-passive-millionaire"
  | "nothing-active-100k"
  | "risk-100x-win"
  | "risk-1000x-win"
  | "no-sales-billionaire"
  | "one-of-everything"
  | "coffee-million"
  | "all-upgrades-max"
  | "planetary-from-nothing"
  | "spend-elon-benchmark"
  | "spendutall-super"
  | "play-1s"
  | "play-10s"
  | "play-1m"
  ...
  | "play-7d"
  | "risk-survive-30m"
  | "nothing-million-under-60s"
  | "spendutall-after-24h"
  | "explicit-first-loan"
  | "explicit-million-leverage"
  | "explicit-clean-payoff"
  | "explicit-debt-free"
  | "explicit-seizure"
  | "explicit-court-filed"
  | "explicit-court-settled"
  | "explicit-judgment"
  | "explicit-credit-recovery"
  | "explicit-house-of-cards"
  | "explicit-autopay"
  | "explicit-refinanced"
...
export type CardGameplayProgress = {
  activitiesCompleted: number;
  timeEventsEncountered: number;
  marketEventsEncountered: number;
  businessBoostUntilGameMinute: number;
...
export type GameState = {
  ...
  customScenario: CustomScenarioDefinition | null;
  mode: FinancialMode;
  cash: number;
  totalSpent: number;
  totalSold: number;
